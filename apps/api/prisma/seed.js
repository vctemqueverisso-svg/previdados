...
async function main() {
    ...
    const client = await prisma.client.upsert({
        ...
        create: {
            ...
            gender: client_1.Gender.FEMININO,
            phone: "(11) 99999-0000",
    ...
    const legalCase = await prisma.case.upsert({
        ...
        create: {
            ...
            channelType: client_1.ChannelType.JUDICIAL,
            benefitType: client_1.BenefitType.AUXILIO_DOENCA,
            ...
            currentStatus: client_1.CaseStatus.AGUARDANDO_DECISAO,
            strategySummary: "Foco em incapacidade total para atividade habitual.",
            createdByUserId: admin.id,
            result: {
                create: {
                    administrativeResult: client_1.OutcomeStatus.INDEFERIDO,
                    judicialResult: client_1.OutcomeStatus.PARCIALMENTE_PROCEDENTE,
                    finalOutcome: client_1.OutcomeStatus.PARCIALMENTE_PROCEDENTE,
    ...
    await prisma.case.upsert({
        ...
        create: {
            ...
            channelType: client_1.ChannelType.ADMINISTRATIVO,
            benefitType: client_1.BenefitType.BPC_LOAS,
            ...
            city: "Sao Paulo",
            state: "SP",
            currentStatus: client_1.CaseStatus.EM_ANALISE,
            createdByUserId: admin.id,
            result: {
                create: {
                    administrativeResult: client_1.OutcomeStatus.PENDENTE,
                    finalOutcome: client_1.OutcomeStatus.PENDENTE
                }
            }
        }
    });
