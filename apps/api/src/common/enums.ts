...
export enum ProceduralEventType {
  ...
  PERICIA_MEDICA_ADMINISTRATIVA = "PERICIA_MEDICA_ADMINISTRATIVA",
  PERICIA_SOCIAL_ADMINISTRATIVA = "PERICIA_SOCIAL_ADMINISTRATIVA",
  DECISAO_ADMINISTRATIVA = "DECISAO_ADMINISTRATIVA",
  AJUIZAMENTO = "AJUIZAMENTO",
  PERICIA_JUDICIAL = "PERICIA_JUDICIAL",
  PERICIA_MEDICA_JUDICIAL = "PERICIA_MEDICA_JUDICIAL",
  PERICIA_SOCIAL_JUDICIAL = "PERICIA_SOCIAL_JUDICIAL",
  SENTENCA = "SENTENCA",
  RECURSO = "RECURSO",
  ACORDAO = "ACORDAO",
