    ...
    <div className="space-y-8">
      <section className="grid gap-6 xl:grid-cols-[1.15fr_0.85fr]">
        <div className="card p-7">
          <p className="eyebrow">CRM previdenciario</p>
          ...
          <p className="mt-4 max-w-3xl text-[15px] leading-7 text-slate-600">
            A pagina inicial agora foi pensada como mesa de trabalho do escritorio: menos enfeite, leitura mais rapida e foco
            no que ajuda voce a atender, acompanhar e decidir.
          </p>
